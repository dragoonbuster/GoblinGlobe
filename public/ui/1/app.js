...
function showToast(message, type = 'success', duration = 3000) {
  ...
  closeBtn.innerHTML = '×';
  closeBtn.style.cssText = 'background: none; border: none; font-size: 18px; cursor: pointer; margin-left: 15px;';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('Goblin Globe Domain Finder - Keyboard Shortcuts:');
